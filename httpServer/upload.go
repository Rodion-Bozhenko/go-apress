...
func HandleMultipartFormWithMultipleFiles(writer http.ResponseWriter, request *http.Request) {
...
func init() {
	...
	http.HandleFunc("/forms/upload", HandleMultipartFormWithMultipleFiles)
}
